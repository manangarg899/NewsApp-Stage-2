...
public class NewsActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<News>> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (activeNetwork != null && activeNetwork.isConnectedOrConnecting()) {
            ...
            Snackbar.make(coordinatorLayout, R.string.NoInternet, LENGTH_INDEFINITE).setAction("SETTINGS", new View.OnClickListener() {
                @Override
   ...
   ListView newsList = (ListView) findViewById(R.id.list_item);
    ...
    public Loader<List<News>> onCreateLoader(int id, Bundle args) {
        ...
        String newsChoice = sharedPrefs.getString(getString(R.string.List_preference_key), getString(R.string.EditPrefDefaultValue));
        String news_Size = sharedPrefs.getString(getString(R.string.EditPrefKey), getString(R.string.EditPrefDefaultValue));
